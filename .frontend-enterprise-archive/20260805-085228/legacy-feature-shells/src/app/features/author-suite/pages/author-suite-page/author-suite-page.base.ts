...
export abstract class AuthorSuitePageBase {
  ...
  readonly stories: readonly Story[] = [
    {
      ...
      status: 'Đang ra',
      tone: 'green',
      image: '/assets/author-suite/story-1.svg',
    },
    {
      id: 2,
      title: 'Thiên Vực Quỷ Thần',
      genre: 'Huyền huyễn',
      chapters: 321,
      reads: '1.6M',
      followers: '26.2K',
      ...
      status: 'Đang ra',
      tone: 'green',
      image: '/assets/author-suite/story-2.svg',
    },
    {
      id: 3,
      title: 'Vạn Cổ Đế Tôn',
      ...
      status: 'Đang ra',
      tone: 'green',
      image: '/assets/author-suite/story-3.svg',
    },
    {
      id: 4,
      title: 'Đoạt Thiên Chi Lộ',
      genre: 'Kiếm hiệp',
      chapters: 128,
      reads: '890K',
      followers: '12.6K',
      ...
      status: 'Hoàn thành',
      tone: 'blue',
      image: '/assets/author-suite/story-4.svg',
    },
    {
      id: 5,
      title: 'Huyền Thiên Liên',
      genre: 'Tiên hiệp',
      chapters: 125,
      reads: '680K',
      followers: '8.2K',
      ...
      status: 'Tạm ngưng',
      tone: 'orange',
      image: '/assets/author-suite/story-5.svg',
    },
  ];
  ...
  readonly chartPoints =
    '0,160 40,132 80,85 120,98 160,72 200,55 240,68 280,45 320,42 360,60 400,30 440,38 480,21 520,48 560,42 600,27';
