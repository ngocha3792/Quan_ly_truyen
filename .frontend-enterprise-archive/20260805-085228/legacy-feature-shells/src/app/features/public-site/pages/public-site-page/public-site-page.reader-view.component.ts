...
@Component({
  selector: 'app-public-site-reader-view',
  standalone: true,
  imports: [PublicSiteIconComponent, RouterLink],
  templateUrl: './public-site-page.reader-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PublicSiteReaderViewComponent extends PublicSitePageBase {}
