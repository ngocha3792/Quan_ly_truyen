...
@Component({
  selector: 'app-admin-center-overview-view',
  standalone: true,
  imports: [AdminCenterIconComponent, RouterLink],
  templateUrl: './admin-center-page.overview-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AdminCenterOverviewViewComponent extends AdminCenterPageBase {}
