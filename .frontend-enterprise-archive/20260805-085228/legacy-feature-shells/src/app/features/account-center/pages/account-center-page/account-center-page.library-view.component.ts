...
@Component({
  selector: 'app-account-center-library-view',
  standalone: true,
  imports: [AccountCenterIconComponent],
  templateUrl: './account-center-page.library-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AccountCenterLibraryViewComponent extends AccountCenterPageBase {}
