...
@Component({
  selector: 'app-account-center-profile-view',
  standalone: true,
  imports: [AccountCenterIconComponent],
  templateUrl: './account-center-page.profile-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AccountCenterProfileViewComponent extends AccountCenterPageBase {}
