...
@Component({
  selector: 'app-public-site-story-view',
  standalone: true,
  imports: [PublicSiteIconComponent, RouterLink],
  templateUrl: './public-site-page.story-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PublicSiteStoryViewComponent extends PublicSitePageBase {}
