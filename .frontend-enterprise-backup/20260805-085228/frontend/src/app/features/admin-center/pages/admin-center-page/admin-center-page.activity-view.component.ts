...
@Component({
  selector: 'app-admin-center-activity-view',
  standalone: true,
  imports: [AdminCenterIconComponent],
  templateUrl: './admin-center-page.activity-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AdminCenterActivityViewComponent extends AdminCenterPageBase {}
