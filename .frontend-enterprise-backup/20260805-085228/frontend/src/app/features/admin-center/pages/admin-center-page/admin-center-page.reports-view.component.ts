...
@Component({
  selector: 'app-admin-center-reports-view',
  standalone: true,
  imports: [AdminCenterIconComponent],
  templateUrl: './admin-center-page.reports-view.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AdminCenterReportsViewComponent extends AdminCenterPageBase {}
