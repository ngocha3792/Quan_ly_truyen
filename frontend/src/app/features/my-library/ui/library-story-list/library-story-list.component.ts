    ...
    >
      @for (story of stories; track story.id) {
        ...
        <div class="empty-state">
          ...
          <p>
            Thư viện không có truyện phù hợp với bộ lọc hiện tại.
          </p>
        </div>
      }
    </section>
