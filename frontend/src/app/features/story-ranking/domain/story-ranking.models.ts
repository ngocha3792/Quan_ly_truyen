export type StoryRankingPeriod =
    | 'day'
    | 'week'
    | 'month'
    | 'all';

export type StoryRankingMetric =
    | 'popular'
    | 'rating'
    | 'followers'
    | 'trending';
...
export const DEFAULT_STORY_RANKING_QUERY:
    StoryRankingQuery = {
    period: 'week',
    metric: 'popular',
    limit: 10,
...
export const EMPTY_STORY_RANKING_OVERVIEW:
