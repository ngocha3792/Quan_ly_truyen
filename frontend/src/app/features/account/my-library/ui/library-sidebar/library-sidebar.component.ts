    ...
    <aside class="library-sidebar">
      ...
      <section class="sidebar-card quick-card">
        <header class="quick-header">
          ...
          <a routerLink="/lich-su-doc"> Xem tất cả </a>
        </header>

        <div class="quick-list">
          @for (item of quickItems; track item.id) {
            <a class="quick-item" [routerLink]="['/truyen', item.slug, 'chuong', item.chapter]">
              ...
              <span class="quick-information">
                ...
                <small> Chương {{ item.chapter }} </small>
              ...
              <strong class="quick-percentage"> {{ item.progress }}% </strong>
            </a>
          }
        </div>
      </section>
      ...
      <section class="sidebar-card goal-card">
        ...
        <div class="goal-content">
          ...
          <div class="goal-progress">
            <span [style.width.%]="getGoalProgress()"></span>
          </div>
