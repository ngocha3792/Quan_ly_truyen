...
@Component({
    selector:
        'app-account-overview-page',
    standalone: true,
    imports: [
        AccountOverviewCardComponent,
        AccountActionCardComponent,
    ],
    templateUrl:
        './account-overview-page.component.html',
    styleUrl:
        './account-overview-page.component.scss',
    changeDetection:
...
export class AccountOverviewPageComponent
    ...
    protected readonly quickActions:
        readonly AccountQuickAction[] = [
            {
                title: 'Thông tin cá nhân',
                description:
                    'Cập nhật tên hiển thị, email và thông tin cá nhân của bạn.',
            ...
            },
            {
                title: 'Bảo mật',
                description:
                    'Đổi mật khẩu và quản lý các tùy chọn bảo mật.',
            ...
            },
            {
                ...
                description:
                    'Xem các hoạt động gần đây trên tài khoản của bạn.',
