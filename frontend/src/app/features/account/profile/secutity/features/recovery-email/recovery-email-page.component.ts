...
@Component({
    ...
    templateUrl:
        './recovery-email-page.component.html',

    styleUrl:
        './recovery-email-page.component.scss',

    changeDetection:
        ChangeDetectionStrategy.OnPush,
})
export class RecoveryEmailPageComponent
    implements OnInit {
    protected readonly store =
        inject(RecoveryEmailStore);

    protected readonly verificationCode =
        signal('');
