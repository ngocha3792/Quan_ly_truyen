...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, RouterLinkActive, IconComponent, UserAvatarComponent],
...
export class AccountSidebarComponent {
  ...
  protected readonly navigation: readonly AccountNavigationItem[] = [
    {
      label: 'Tổng quan',
      route: '/tai-khoan',
      icon: 'grid',
  ...
  protected getRoleLabel(roles: readonly string[]): string {
    ...
    if (normalizedRoles.includes('author')) {
      return 'Tác giả';
    }
