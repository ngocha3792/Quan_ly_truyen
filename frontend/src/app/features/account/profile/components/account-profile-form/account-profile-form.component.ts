...
} from '../../data/account-profile.models';
...
@Component({
    ...
    templateUrl:
        './account-profile-form.component.html',
    styleUrl:
...
export class AccountProfileFormComponent {
    ...
    readonly preferences =
        input.required<AccountUiPreferences>();

    readonly saveRequested =
        output<AccountProfileFormValue>();

    readonly avatarSelected =
        output<File | null>();

    readonly preferencesChanged =
        output<Partial<AccountUiPreferences>>();

    readonly cancelRequested =
        output<void>();

    private readonly initialSnapshot =
        injectInitialSnapshot();

    protected readonly form =
        new FormGroup<ProfileForm>({
