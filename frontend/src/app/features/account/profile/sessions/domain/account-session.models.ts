...
export type SessionBrowser = 'chrome' | 'edge' | 'firefox' | 'safari' | 'opera' | 'browser';

export type SessionDeviceType = 'desktop' | 'mobile' | 'tablet' | 'unknown';

export type SessionStatus = 'current' | 'active' | 'expired' | 'revoked';

export type SessionFilter = 'all' | 'active' | 'expired' | 'trusted';
...
export interface LoginActivityViewModel {
  ...
  readonly status: 'current' | 'active' | 'signed-out';
