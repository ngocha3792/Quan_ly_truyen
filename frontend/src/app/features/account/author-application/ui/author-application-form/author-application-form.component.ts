...
@Component({
    ...
    <section class="application-form-card">
      ...
      >
        <div class="form-grid">
          ...
          <div class="form-field">
            <label for="author-portfolio">
              Liên kết Facebook / Portfolio
            </label>
          ...
          <div class="form-field">
            ...
            <div class="select-wrap">
              ...
              >
                ...
                @for (
                  option of config.experienceOptions;
                  track option.value
                ) {
                  <option
                    [value]="option.value"
        ...
        <div class="form-field form-field--full">
          ...
          <span class="character-count">
            {{
              form.controls.firstWorkSynopsis
                .value.length
            }}
            /
            {{
          ...
          @if (
            ...
            <small class="field-error">
              Vui lòng nhập ý tưởng hoặc tóm tắt tác phẩm.
            </small>
          }
        </div>
  ...
  `,
    ...
    .submit-button {
      ...
      box-shadow:
        0 7px 21px rgba(126, 34, 206, 0.23);
    }
...
export class AuthorApplicationFormComponent {
    ...
    readonly submitApplication =
        new EventEmitter<AuthorApplicationPayload>();

    @Output()
    readonly saveDraft =
        new EventEmitter<AuthorApplicationDraft>();

    protected readonly dragging =
        signal(false);

    protected readonly selectedFile =
        signal<File | null>(null);

    protected readonly fileError =
        signal('');
    ...
    protected get acceptedFileTypes():
        string {
        return this.config
    ...
    protected handleSubmit(): void {
        ...
        if (!file) {
            this.fileError.set(
                'Vui lòng đính kèm mẫu chương truyện.',
            );
        }
    ...
    private validateAndSelectFile(
        ...
        if (file.size > maximumBytes) {
            ...
            this.fileError.set(
                `Dung lượng file không được vượt quá ${this.config.maximumFileSizeMb}MB.`,
            );
