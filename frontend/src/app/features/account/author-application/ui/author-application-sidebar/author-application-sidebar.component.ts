    ...
    <aside class="application-sidebar">
      <section class="author-banner">
        ...
        <div>
          ...
          <p>
            Chia sẻ câu chuyện của bạn đến hàng triệu độc giả.
          </p>
        </div>

        <span
          class="banner-sparkle"
          aria-hidden="true"
        >
          ✦
        </span>
      ...
      <section class="sidebar-card">
        <header>
          <svg viewBox="0 0 24 24">
            ...
            <path
              d="M7 6H4v1a4 4 0 0 0 4 4"
            ></path>

            <path
              d="M17 6h3v1a4 4 0 0 1-4 4"
            ></path>
          </svg>
                ...
                @switch (benefit.icon) {
                  ...
                  @default {
                    <svg viewBox="0 0 24 24">
                      ...
                      <path
                        d="M2.5 20c.5-4 2.3-6 5.5-6s5 2 5.5 6"
                      ></path>

                      <path
                        d="M14 14c3.7 0 5.8 2 6.3 5"
                      ></path>
                    </svg>
                  }
                }
