...
export class AuthorApplicationStore {
    private readonly repository =
        inject(AuthorApplicationRepository);

    private readonly destroyRef =
        inject(DestroyRef);

    private readonly configState =
        signal<AuthorApplicationConfig | null>(
            null,
        );

    private readonly resultState =
        signal<AuthorApplicationResult | null>(
            null,
        );
    ...
    readonly status =
        signal<AuthorApplicationStatus>('idle');
        ...
        this.repository
            ...
            .subscribe({
                ...
                error: () => {
                    ...
                    this.errorMessage.set(
                        'Không thể tải biểu mẫu đăng ký tác giả.',
                    );
                },
            });
    }
