...
export const AUTHOR_APPLICATION_CONFIG_MOCK: AuthorApplicationConfig = {
  genreOptions: [
    {
      value: 'tien-hiep',
      label: 'Tiên hiệp',
  ...
  reviewSteps: [
    ...
    },
    {
      ...
      description: 'Chúng tôi xem xét hồ sơ trong 3–5 ngày làm việc.',
    },
    {
      number: 3,
      title: 'Kích hoạt hồ sơ tác giả',
      description: 'Nhận thông báo và bắt đầu đăng tải tác phẩm.',
    },
  ],
...
export const AUTHOR_APPLICATION_RESULT_MOCK: AuthorApplicationResult = {
  applicationId: 'AUTHOR-APPLICATION-2026-001',
  submittedAt: new Date().toISOString(),
  message: 'Yêu cầu của bạn đã được gửi. Hồ sơ sẽ được xem xét trong 3–5 ngày làm việc.',
};
