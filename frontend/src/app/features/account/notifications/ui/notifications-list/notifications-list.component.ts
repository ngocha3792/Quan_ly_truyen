      ...
      @for (
        ...
        >
          <button
            ...
            "
            (click)="
              readToggle.emit(notification.id)
            "
          >
            <span></span>
          </button>
            ...
            @switch (notification.type) {
              ...
              @case ('promotion') {
                <svg viewBox="0 0 24 24">
                  ...
                  <path
                    d="M12 8H8.5A2.5 2.5 0 1 1 11 5.5L12 8Z"
                  ></path>

                  <path
                    d="M12 8h3.5A2.5 2.5 0 1 0 13 5.5L12 8Z"
                  ></path>
                </svg>
              }
          ...
          <button
            ...
            "
            (click)="
              savedToggle.emit(notification.id)
            "
          >
            <svg viewBox="0 0 24 24">
              <path
