...
export class AuthorDirectoryStore {
    private readonly repository =
        inject(AuthorDirectoryRepository);

    private readonly viewState =
        signal<AuthorDirectoryView | null>(null);
    ...
    readonly authors = computed(() => {
        ...
        return this.filteredAuthors().slice(
            startIndex,
