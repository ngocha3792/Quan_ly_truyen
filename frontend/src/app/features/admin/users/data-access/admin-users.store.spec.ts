...
describe(
  ...
  () => {
    ...
    it(
      'suspend phải cập nhật detail theo server response',
    ...
    it(
      'assign ADMIN phải cập nhật role trong detail',
    ...
    it(
      'detail response cũ không được ghi vào session manager mới',
