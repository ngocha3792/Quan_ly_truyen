...
export type AuthorStudioPeriod =
    | '7d'
    | '30d'
    | '90d';

export type StudioMetricTone =
    | 'purple'
    | 'blue'
    | 'orange'
    | 'indigo'
...
export interface AuthorStudioDashboard {
    ...
    readonly stories:
    readonly AuthorStudioStory[];

    readonly drafts:
    readonly AuthorStudioDraft[];

    readonly comments:
    readonly AuthorReaderComment[];

    readonly topStories:
    readonly AuthorTopStory[];

    readonly monthlyGoals:
