...
export const AUTHOR_STUDIO_MOCK:
    AuthorStudioDashboard = {
    profile: {
    ...
    schedule: [
        {
            ...
            chapterTitle:
                'Chương 326: Quyết Chiến Thiên Ma',
            time: '20:00',
            status: 'scheduled',
        ...
        },
        {
            ...
            chapterTitle:
                'Chương 584: Truyền Thừa Cổ Thần',
            time: '20:00',
            status: 'published',
            statusLabel: 'Đã lên lịch',
            coverUrl:
    ...
    drafts: [
        ...
        },
        {
            id: 'draft-3',
            storyTitle:
                'Ta Có Một Tòa Luyện Đan Lâu',
            chapterTitle:
                'Chương 113: Đan Phương Mới',
    ...
    comments: [
        {
            ...
            storyTitle: 'Đại Đạo Chí Tôn',
            content:
                'Truyện càng ngày càng hay, mong tác giả ra chương đều nhé! 💪',
        ...
        },
        {
            ...
            storyTitle: 'Vạn Cổ Thần Đế',
            content:
                'Chương này quá đỉnh! Có thể giải thích thêm về bí cảnh không?',
        ...
        },
        {
            ...
            storyTitle: 'Kiếm Vực Độc Tôn',
            content:
                'Kiếm ý của nhân vật chính thật sự quá ngầu!',
