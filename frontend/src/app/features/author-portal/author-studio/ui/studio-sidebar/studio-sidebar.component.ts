...
@Component({
    ...
    <aside class="studio-sidebar">
      ...
      <section class="author-profile-card">
        ...
        <a
          routerLink="/author-studio/ho-so"
          (click)="navigated.emit()"
        >
          <app-studio-icon
            name="user"
  ...
  `,
    ...
    .studio-sidebar {
      ...
      overflow-y: auto;
      border-right:
        1px solid rgba(128, 143, 180, 0.16);
      background:
        radial-gradient(
          circle at 30% 20%,
          rgba(111, 44, 196, 0.11),
          transparent 30%
        ),
        #08111f;
    }
    ...
    .author-profile-card {
      ...
      border:
        1px solid rgba(128, 143, 180, 0.17);
      border-radius: 10px;
      background:
        linear-gradient(
          145deg,
    ...
    .author-profile-card > a {
      ...
      min-height: 36px;
      grid-template-columns:
        20px minmax(0, 1fr) 16px;
      align-items: center;
      gap: 7px;
      margin-top: 16px;
      padding: 0 12px;
      border:
        1px solid rgba(130, 145, 184, 0.22);
      border-radius: 7px;
    ...
    protected readonly navigationItems:
        readonly StudioNavigationItem[] = [
            ...
            },
            {
                label: 'Chương truyện',
                route:
                    '/author-studio/chuong',
                icon: 'chapter',
            },
            {
                label: 'Bản nháp',
                route:
                    '/author-studio/ban-nhap',
                icon: 'draft',
            },
            {
                label: 'Lịch xuất bản',
                route:
                    '/author-studio/lich-xuat-ban',
                icon: 'calendar',
            },
            {
                label: 'Bình luận độc giả',
                route:
                    '/author-studio/binh-luan',
                icon: 'comment',
            },
            {
                label: 'Thống kê',
                route:
                    '/author-studio/thong-ke',
                icon: 'chart',
            },
            {
                label: 'Nhuận bút',
                route:
                    '/author-studio/nhuan-but',
                icon: 'wallet',
            },
            {
                label: 'Hồ sơ tác giả',
            ...
            },
            {
                label: 'Cài đặt',
                route:
                    '/author-studio/cai-dat',
                icon: 'settings',
            },
        ];

    protected get experiencePercent():
        number {
        ...
        return Math.min(
            ...
            Math.round(
                (
                    this.profile.currentExperience /
                    this.profile.requiredExperience
                ) * 100,
            ),
        );
    }
