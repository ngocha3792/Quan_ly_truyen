...
@Component({
    ...
    <section class="quick-actions dashboard-card">
      ...
      <div class="action-grid">
        <a
          ...
          routerLink="/author-studio/chuong/tao-moi"
        >
          <app-studio-icon
            name="edit"
            [size]="28"
        ...
        <a
          ...
          routerLink="/author-studio/thong-ke"
        >
          <app-studio-icon
            name="chart"
            [size]="28"
    ...
    <section class="top-stories dashboard-card">
      <header>
        ...
        <a routerLink="/author-studio/thong-ke">
          Xem tất cả
        </a>
      </header>
    ...
    <section class="monthly-goals dashboard-card">
      ...
      <div class="goal-list">
        @for (
          goal of monthlyGoals;
          track goal.id
        ) {
          <article
            [attr.data-tone]="goal.tone"
          >
...
export class DashboardBottomPanelsComponent {
    @Input({ required: true })
    topStories:
        readonly AuthorTopStory[] = [];

    @Input({ required: true })
    monthlyGoals:
        readonly AuthorMonthlyGoal[] = [];
}