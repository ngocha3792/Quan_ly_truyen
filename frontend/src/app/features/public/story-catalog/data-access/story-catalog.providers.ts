...
export function provideStoryCatalog(
    options: StoryCatalogProviderOptions,
): Provider[] {
    return [
        {
            provide:
            ...
            useFactory: (
                ...
                catalog:
                    `${config.apiBaseUrl}/stories`,

                genres:
                    `${config.apiBaseUrl}/story-genres`,

                ranking:
                    `${config.apiBaseUrl}/stories/ranking`,
            }),
        },

        {
            ...
            useClass: options.useMock
                ? StoryCatalogMockRepository
                : StoryCatalogHttpRepository,
        },
