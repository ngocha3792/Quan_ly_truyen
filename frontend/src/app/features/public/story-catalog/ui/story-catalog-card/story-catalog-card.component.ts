...
@Component({
  selector: 'app-story-catalog-card',

  standalone: true,

  imports: [RouterLink, IconComponent, CompactNumberPipe],

  templateUrl: './story-catalog-card.component.html',

  styleUrl: './story-catalog-card.component.scss',

  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StoryCatalogCardComponent {
  readonly story = input.required<StoryCatalogItem>();
