...
export const STORY_UPDATES_ENDPOINTS = new InjectionToken<StoryUpdatesEndpoints>(
  'STORY_UPDATES_ENDPOINTS',
);

export abstract class StoryUpdatesRepository {
  abstract getOverview(query: StoryUpdatesQuery): Observable<StoryUpdatesOverview>;
}
