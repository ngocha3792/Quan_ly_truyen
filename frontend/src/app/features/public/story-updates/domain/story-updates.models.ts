...
export type StoryUpdateBadge =
    | 'featured'
    | 'hot'
    | 'new'
    | null;

export type StoryUpdateStatTone =
    | 'purple'
    | 'blue'
    | 'pink'
    | 'orange';
...
export const DEFAULT_STORY_UPDATES_QUERY:
    StoryUpdatesQuery = {
    tab: 'all',
    sort: 'latest',
...
export const EMPTY_STORY_UPDATES_OVERVIEW:
