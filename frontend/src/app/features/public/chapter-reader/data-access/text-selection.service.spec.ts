...
describe('TextSelectionService', () => {
  it('converts a DOM selection into stable block-relative offsets', () => {
    ...
    container.innerHTML = '<p data-block-id="11111111-1111-4111-8111-111111111111"><strong>Một đoạn</strong> văn bản đủ dài</p>';
    ...
    Object.defineProperty(range, 'getClientRects', { value: () => ({ item: () => ({ left: 10, top: 20, width: 30 }) }) });
