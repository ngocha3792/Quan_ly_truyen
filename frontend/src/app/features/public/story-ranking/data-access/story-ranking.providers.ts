...
export function provideStoryRanking(
    options:
        StoryRankingProviderOptions,
): Provider[] {
    return [
        {
            provide:
            ...
            useFactory: (
                ...
                ranking:
                    `${config.apiBaseUrl}/rankings/stories`,

                summary:
                    `${config.apiBaseUrl}/rankings/stories/summary`,

                genres:
                    `${config.apiBaseUrl}/rankings/genres`,

                trends:
                    `${config.apiBaseUrl}/rankings/stories/trends`,
            }),
        },

        {
            ...
            useClass:
                options.useMock
                    ? StoryRankingMockRepository
                    : StoryRankingHttpRepository,
        },
