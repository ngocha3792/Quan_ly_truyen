...

  {
    ...
    children: [
...

      {
        ...
        data: {
          authActionMode: 'forgot-password',
        },
...

      {
        ...
        data: {
          authActionMode: 'confirm-email-change',
        },
...

      {
        ...
        canActivate: [
          ...
          permissionGuard(AUTH_PERMISSIONS.READING_HISTORY_MANAGE_OWN),
        ],
...

      {
        ...
        canActivate: [
          ...
          permissionGuard(AUTH_PERMISSIONS.NOTIFICATION_MANAGE_OWN),
        ],
       ...
       */
      {
        ...
        canActivate: [
          ...
          permissionGuard(AUTH_PERMISSIONS.AUTHOR_APPLICATION_CREATE),
        ],
