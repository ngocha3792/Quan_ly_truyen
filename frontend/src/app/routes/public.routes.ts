...
export const PUBLIC_ROUTES: Routes = [
  {
    ...
    data: {
      seoDescription:
        'Đọc truyện online, khám phá truyện mới cập nhật, bảng xếp hạng và thư viện truyện nổi bật tại TruyenHub.',
    },
  ...
  },
  {
    ...
    data: {
      seoDescription:
        'Thông tin truyện, tác giả, chương mới nhất, đánh giá và nội dung liên quan trên TruyenHub.',
    },
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Đọc chương truyện online với chế độ đọc tối ưu trên TruyenHub.',
    },
  ...
  },
  {
    ...
    data: {
      seoDescription:
        'Duyệt danh sách truyện theo từ khóa, thể loại, trạng thái và mức độ phổ biến trên TruyenHub.',
    },
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Khám phá truyện theo thể loại và tìm các chủ đề đọc phù hợp trên TruyenHub.',
    },
  ...
  },
  {
    ...
    data: {
      seoDescription:
        'Bảng xếp hạng truyện nổi bật theo lượt đọc, đánh giá và xu hướng trên TruyenHub.',
    },
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Theo dõi các truyện và chương mới được cập nhật gần đây trên TruyenHub.',
    },
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Tìm hiểu về TruyenHub và trải nghiệm đọc, quản lý truyện trên nền tảng.',
    },
    loadComponent: () =>
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Điều khoản sử dụng dịch vụ và các nguyên tắc áp dụng khi sử dụng TruyenHub.',
    },
    loadComponent: () =>
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Chính sách quyền riêng tư và cách TruyenHub xử lý dữ liệu người dùng.',
    },
    loadComponent: () =>
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Thông tin hỗ trợ và các kênh liên hệ dành cho người dùng TruyenHub.',
    },
    loadComponent: () =>
  ...
  },
  {
    ...
    data: {
      seoDescription: 'Khám phá tác giả và các tác phẩm nổi bật đang được xuất bản trên TruyenHub.',
    },
    loadComponent: () =>
  ...
  },
  {
    ...
    data: {
      seoDescription:
        'Thông tin tác giả, tiểu sử và danh sách tác phẩm được xuất bản trên TruyenHub.',
    },
    loadComponent: () =>
