  ...
  template: `
    ...
    >
      @switch (name()) {
        ...
        @case ('skull') {
          <path d="M12 2a8 8 0 0 0-5 14.2V20h3v2h4v-2h3v-3.8A8 8 0 0 0 12 2Z" />
        ...
        @case ('masks') {
          <path d="M4 4c4 0 6 1 8 3v8c-2 3-5 5-8 5V4Z" />
          <path d="M20 4c-4 0-6 1-8 3v8c2 3 5 5 8 5V4Z" />
          <path d="M7 10h.01" />
          <path d="M17 10h.01" />
        ...
        @case ('rocket') {
          <path d="M4 13c-1.5 1.3-2 3.3-2 5 1.7 0 3.7-.5 5-2" />
          <path d="M15 3c3-1 5-1 6-1 0 1 0 3-1 6l-7 7-4-4 6-8Z" />
        ...
        @case ('fire') {
          <path
            d="M12 22c4 0 7-3 7-7 0-3-1.5-5.5-4.5-8 .2 2-1.1 3.3-2.3 4.2C11.7 8.5 9.8 5.7 7 4c.3 4-2 6.2-2 10.5C5 18.7 8 22 12 22Z"
          />
          <path d="M9.5 17c0 2 1.1 3 2.5 3s2.5-1 2.5-3c0-1.3-.7-2.5-2.5-4-1.8 1.5-2.5 2.7-2.5 4Z" />
        }
        @case ('sparkles') {
        ...
        @case ('star') {
          <path d="m12 2 3 6.1 6.7 1-4.8 4.7 1.1 6.7-6-3.2-6 3.2 1.1-6.7-4.8-4.7 6.7-1Z" />
        }
        @case ('arrow-right') {
        ...
        @case ('eye-off') {
          ...
          <path d="M9.9 4.2A10.8 10.8 0 0 1 12 4c5 0 9 4 10 8a12.8 12.8 0 0 1-2.1 4.1" />
          <path d="M6.2 6.2A11.8 11.8 0 0 0 2 12c1 4 5 8 10 8a10 10 0 0 0 4.1-.9" />
        }
        @case ('camera') {
          <path
            d="M14.5 4 16 6h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3l1.5-2Z"
          />
