import { PrismaAuthAuditWriterAdapter } from './prisma-auth-audit-writer.adapter';

describe('PrismaAuthAuditWriterAdapter', () => {
  it('redacts sensitive fields before persistence', async () => {
    ...
    const writer = new PrismaAuthAuditWriterAdapter(
      {
        auditLog: {
          create,
        },
