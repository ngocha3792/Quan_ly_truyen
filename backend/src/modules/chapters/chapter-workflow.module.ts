...
import { BulkChapterWorkflowCommandHandler } from './application/commands/bulk-chapter-workflow';
...
import { AuthorBulkChapterWorkflowController } from './presentation/http/controllers/author-bulk-chapter-workflow.controller';
...
@Module({
  ...
  controllers: [
    AuthorChapterWorkflowController,
    AuthorBulkChapterWorkflowController,
    AdminChapterReviewsController,
  ],
  providers: [
