...
export const APPLICATION_ID = '11111111-1111-4111-8111-111111111111';

export const OWNER_ID = '22222222-2222-4222-8222-222222222222';

export const REVIEWER_ID = '33333333-3333-4333-8333-333333333333';

export const SAMPLE_MEDIA_ID = '44444444-4444-4444-8444-444444444444';
...
export function createAuthorApplication(
  ...
  return {
    ...
    introduction: 'Tôi muốn trở thành tác giả trên nền tảng.',

    firstWorkSynopsis: 'Nội dung tóm tắt tác phẩm đầu tiên.',

    acceptedTerms: true,

    sample: null,

    submittedAt: status === AuthorApplicationStatus.DRAFT ? null : now,
