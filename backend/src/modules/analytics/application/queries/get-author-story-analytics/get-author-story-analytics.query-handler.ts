...
import { AUTHOR_ANALYTICS_READER_PORT, type AuthorAnalyticsReaderPort } from '../../ports';
...
export class GetAuthorStoryAnalyticsQueryHandler {
  constructor(@Inject(AUTHOR_ANALYTICS_READER_PORT) private readonly reader: AuthorAnalyticsReaderPort) {
  }
