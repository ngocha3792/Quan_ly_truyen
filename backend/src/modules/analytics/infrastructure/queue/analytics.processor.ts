...
import { PrismaAnalyticsAggregationAdapter } from '../persistence/prisma-analytics-aggregation.adapter';
...
export class AnalyticsProcessor extends WorkerHost {
  constructor(
    private readonly aggregation: PrismaAnalyticsAggregationAdapter,
