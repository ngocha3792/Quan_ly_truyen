...
@Injectable()
export class PrismaReaderAnalyticsIngestionAdapter implements ReaderAnalyticsIngestionPort {
  constructor(
    private readonly prisma: PrismaService,
    private readonly config: ConfigService,
    private readonly identity: HmacAnalyticsIdentityAdapter,
    private readonly limiter: RedisAnalyticsRateLimitAdapter,
  ...
  private validateEvents(
    events: readonly ReaderAnalyticsEventInput[],
