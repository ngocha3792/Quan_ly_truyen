...
import { AUTHOR_PROFILE_PERSISTENCE_PORT, type AuthorProfilePersistencePort } from '../../ports';
import { UpdateAuthorProfileCommand } from './update-author-profile.command';
@Injectable()
export class UpdateAuthorProfileCommandHandler {
  constructor(@Inject(AUTHOR_PROFILE_PERSISTENCE_PORT) private readonly persistence: AuthorProfilePersistencePort) {
  }
