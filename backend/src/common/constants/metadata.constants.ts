...
export const ROUTE_METADATA = {
  ...
  SKIP_RESPONSE_ENVELOPE:
    'quan-ly-truyen:route:skip-response-envelope',
  SKIP_REQUEST_LOGGING:
    'quan-ly-truyen:route:skip-request-logging',
  SKIP_REQUEST_TIMEOUT:
    'quan-ly-truyen:route:skip-request-timeout',
  REQUEST_TIMEOUT_MS:
    'quan-ly-truyen:route:request-timeout-ms',
...
export const SKIP_RESPONSE_ENVELOPE_KEY =
  ROUTE_METADATA.SKIP_RESPONSE_ENVELOPE;
export const SKIP_REQUEST_LOGGING_KEY =
  ROUTE_METADATA.SKIP_REQUEST_LOGGING;
export const SKIP_REQUEST_TIMEOUT_KEY =
  ROUTE_METADATA.SKIP_REQUEST_TIMEOUT;
export const REQUEST_TIMEOUT_MS_KEY =
  ROUTE_METADATA.REQUEST_TIMEOUT_MS;
export const IDEMPOTENT_KEY = ROUTE_METADATA.IDEMPOTENT;
export const CACHE_TTL_SECONDS_KEY =
  ROUTE_METADATA.CACHE_TTL_SECONDS;
