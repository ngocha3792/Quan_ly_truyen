...
const permissions = [
  ...
  [
    ...
    'Manage author lifecycle status',
    'author',
    'status.manage',
  ],
  ...
  [
    'chapter.update.own',
    'Update chapters of own stories',
    'chapter',
    'update.own',
  ],
  [
    'chapter.delete.own',
    'Delete chapters of own stories',
    'chapter',
    'delete.own',
  ],
  [
    'chapter.publish.own',
    'Publish chapters of own stories',
    'chapter',
    'publish.own',
  ],
  ...
  [
    ...
    'Manage own reading history',
    'reading-history',
    'manage.own',
  ],
  [
    'reading-bookmark.manage.own',
    'Manage own reading bookmarks',
    'reading-bookmark',
    'manage.own',
  ],
  [
    'reading-goal.manage.own',
    'Manage own reading goal',
    'reading-goal',
    'manage.own',
  ],
  [
  ...
  [
    ...
    'Purchase chapter access for self',
    'purchase',
    'create.self',
  ],
  [
    'chapter.monetization.manage.own',
    'Manage monetization for own chapters',
    'chapter.monetization',
    'manage.own',
  ],
  [
    'monetization.price-band.manage',
    'Manage monetization price bands',
    'monetization.price-band',
    'manage',
  ],
  [
    'payment.order.create.self',
    'Create own payment order',
    'payment.order',
    'create.self',
  ],
  [
    'payment.order.read.self',
    'Read own payment orders',
    'payment.order',
    'read.self',
  ],
  ['payment.read.admin', 'Read payment operations', 'payment', 'read.admin'],
  [
  ...
  [
    'ai-settings.manage',
    'Manage system-wide AI provider keys',
    'ai-settings',
    'manage',
  ],
] as const;
...
const securityQuestions = [
  ...
  [
    ...
    'Cuốn sách yêu thích thời thơ ấu của bạn là gì?',
    50,
  ],
  ...
  [
    'memorable_place',
    'Địa điểm đáng nhớ nhất trong tuổi thơ của bạn là gì?',
    80,
  ],
] as const;
